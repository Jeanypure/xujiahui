...
/**
 * AuditSupplierSearch represents the model behind the search form of `backend\models\YaeSupplier`.
 */
class AuditSupplierSearch extends YaeSupplier
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['credit_code','supplier_code', 'supplier_name', 'pd_bill_name', 'bill_unit', 'submitter', 'business_licence', 'bank_account_data', 'pay_card', 'pay_name', 'pay_bank', 'sup_remark', 'account_proportion', 'bill_img1', 'bill_img1_name_unit', 'bill_img2', 'bill_img2_name_unit', 'complete_num', 'supplier_address', 'check_memo'], 'safe'],
        ];
    }
