...
class PurInfo extends \yii\db\ActiveRecord
{
    public $view_status,$submit_manager,$result, $spur_info_id, $is_agreest, $create_date,$pay_amount,$has_arrival,
        ...
        $sample_submit2,$submit1_at,$submit2_at,$cancel1_at,$cancel2_at,$has_pay,$is_quality,$submit_leader;
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        ...
        return [
            [['is_assign_a','trading_company','source','brocast_status','is_quality','sample_submit1','sample_submit2','pur_complete_status','is_assign','junior_submit','pur_group', 'pd_purchase_num', 'parent_product_id','preview_status'], 'integer'],
