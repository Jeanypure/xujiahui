...
//找到产品推荐模块并追加<span>
    ...
    $("a span:contains('公示列表2')").after('<sup class="label label-danger">{$status_map["公示列表2"]}</sup>');
    $("a span:contains('产品评审')").after('<sup class="label label-success">{$status_map["产品评审"]}</sup>');
