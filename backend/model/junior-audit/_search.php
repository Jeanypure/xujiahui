...
/* @var $model backend\models\JuniorAuditSearch */
...
<div class="pur-info-search">
    ...
    <?php // echo $form->field($model, 'assign_member') ?>
    ...
    <?php // echo $form->field($model, 'is_patent_right') ?>

    <?php // echo $form->field($model, 'is_third_party_abroad_right') ?>

    <?php // echo $form->field($model, 'promise_rights') ?>

    <?php // echo $form->field($model, 'special_auth_FDA') ?>
    ...
    <?php // echo $form->field($model, 'sure_purchase_time') ?>
