...
<div class="pur-info-form">
    ...
    <?= $form->field($model, 'trading_company')->textInput() ?>

    <?= $form->field($model, 'purchaser_send_time')->textInput() ?>

    <?= $form->field($model, 'is_patent_right')->textInput() ?>

    <?= $form->field($model, 'is_third_party_abroad_right')->textInput() ?>

    <?= $form->field($model, 'promise_rights')->textInput() ?>

    <?= $form->field($model, 'special_auth_FDA')->textInput() ?>
